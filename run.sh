...
/usr/local/bin/ovpn_genconfig -u udp://$VPN_PUBLIC_IP:1194 
...
config setup
  virtual-private=%v4:10.0.0.0/8,%v4:192.168.0.0/16,%v4:172.16.0.0/12,%v4:!192.168.42.0/24,%v4:!192.168.43.0/24,%v4:!$PGW_RIGHT_SUBNETS
  protostack=netkey
...
# Specify Static IP for clients
cat > /etc/openvpn/ccd/${OVPN_INTEGRATOR_NAME} <<EOF
